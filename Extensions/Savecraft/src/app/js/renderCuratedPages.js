      ...
      <div class="bare-list-body">
        ...
        <div class="bare-list-rows">
          <button class="bare-list-filter-trigger" type="button">
            <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><line x1="4" y1="5" x2="20" y2="5"/><line x1="4" y1="12" x2="20" y2="12"/><line x1="4" y1="19" x2="20" y2="19"/><circle cx="9" cy="5" r="2.6" fill="currentColor" stroke="none"/><circle cx="15" cy="12" r="2.6" fill="currentColor" stroke="none"/><circle cx="8" cy="19" r="2.6" fill="currentColor" stroke="none"/></svg>
