...
*(The session before that — a quick-queue bookmark for curated cards, then a full "Top 100" landing page built as a live demo for pitching nonprofits on sponsoring their own curated list — has rolled off this section. See git history around that era if needed.)*
