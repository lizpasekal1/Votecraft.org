...
*The session before that — seeded 214 more IMDb Top 250 movies into curated Top 100, split "Curated SaveCraft" into a real two-tier browsing experience, and wired up the previously-dead "Shared Saves" dropdown item for the first time — has rolled off this file's window. See git history around that era if needed.*
