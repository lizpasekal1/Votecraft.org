...
**Theme: folders went from decorative to functional, which cascaded into how top-level tabs filter.**
...
```js
const CATEGORIES = ['Web Links', 'Visual Art', 'Book', 'Game', 'News', 'Movie', 'Musician', 'Music Album', 'Show'];

const CAT_LABEL = {
  'Web Links': 'Website', 'News': 'News',
