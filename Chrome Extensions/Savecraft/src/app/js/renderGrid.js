...
export function renderGrid() {
  ...
  if (state.view === 'all') {
    ...
    // sits on this same row (#grid-title is itself a flex row — see cards.css), pushed to the
    // right edge via its own margin-left: auto, per a follow-up request putting it back up from
    // .grid-header's row below to here instead.
