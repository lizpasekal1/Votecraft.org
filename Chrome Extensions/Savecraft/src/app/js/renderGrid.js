...
export function renderGrid() {
  ...
  // Reset by default, populated only by the three Top 100 branches below (Musician/Show/Book,
  // Game, Movie) — otherwise a publication logo from a previous Top 100 visit would keep showing
  // in .grid-header on every other view after navigating away.
  document.getElementById('grid-header-logo-slot').innerHTML = '';
