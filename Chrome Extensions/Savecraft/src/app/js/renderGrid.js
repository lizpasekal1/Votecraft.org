...
export function renderGrid() {
  ...
  if (state.view === 'all') {
    ...
    if (state.view === 'genre:Top 100:Musician' || state.view === 'genre:Top 100:Show' || state.view === 'genre:Top 100:Book') {
      ...
      gridTitle.innerHTML = `${label} <span class="rs-logo-wrap"><img src="${resourceUrl('images/logos/pngkey.com-rolling-stones-tongue-png-3135824.png')}" class="rs-logo-img" alt="Rolling Stone"></span>`;
    } else if (state.view === 'genre:Top 100:Game') {
      gridTitle.innerHTML = `${top100Label} Games <span class="steam-logo-wrap"><img src="${resourceUrl('images/logos/steam.png')}" class="steam-logo-img" alt="Steam"></span>`;
