...
export const CAT_LABEL = {
  ...
  // 'Shows' -> 'Series', per direct correction — its old TV-show content moved to Films' "Shows"
  // folder (default-movies-series, storage.js), so this tab's own remaining folders
  // (Creators/Podcasts/Tutorials/Web Series) read better under "Series" than "Shows" now.
  'Show': 'Series', 'Visual Art': 'Arts',
};
