    ...
    <div class="profile-card profile-card--account-details">
      ...
      <div class="form-group">
        ...
        <div class="profile-masked-field-row">
          ...
          <!-- Per direct request ("in mobile make the update button just be a pencil icon in a
               purple square. this way the email field can be longer.") — both the icon and the
               "Update" label are always in the markup; misc.css's mobile media query hides the
               label and squares the button down to icon-only, rather than two different button
               markups swapped by viewport. -->
          <button type="button" class="btn-primary profile-inline-field-btn" id="profile-change-email-btn"${disabledAttr}>
            <svg class="profile-update-btn-icon" xmlns="http://www.w3.org/2000/svg" height="14px" viewBox="0 -960 960 960" width="14px" fill="currentColor"><path d="M200-200h57l391-391-57-57-391 391v57Zm-80 80v-170l528-527q12-11 26.5-17t30.5-6q16 0 31 6t26 18l55 56q12 11 17.5 26t5.5 30q0 16-5.5 30.5T817-647L290-120H120Zm640-584-56-56 56 56Zm-141 85-28-29 57 57-29-28Z"/></svg>
            <span class="profile-update-btn-label">Update</span>
          </button>
        </div>
      </div>
      <div class="form-group">
