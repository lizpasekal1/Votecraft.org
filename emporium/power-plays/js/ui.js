...
class UIManager {
    ...
    renderOpponents() {
        ...
        opponents.forEach(opponent => {
            ...
            opponentEl.innerHTML = `
                ...
                <div class="opponent-count">${opponent.handSize()} cards | ${opponent.lobbyCards.length} lobby card${opponent.lobbyCards.length !== 1 ? 's' : ''}</div>
            `;
    ...
    renderPlayerHand() {
        ...
        const totalLobby = player.lobbyCards.length;
    ...
    showGameOverScreen(powerWinner, playsWinner) {
        return new Promise(resolve => {
            ...
            players.forEach(p => {
                ...
                const totalLobby = p.lobbyCards.length;
