    ...
    <div class="vote-widget">
        <div class="vote-layout">
            ...
            <aside class="left-panel">
                <a href="https://votecraft.org/vote/" class="sidebar-logo">
                    <img src="https://votecraft.org/wp-content/uploads/2023/07/vote-craft-logo_2.png" alt="VoteCraft">
                </a>
                ...
                <div id="reps-panel" class="panel-content">
                    <div id="federal-senators-section" class="rep-section">
                        <h3 class="rep-section-title">Federal Senators</h3>
                    ...
                    <div class="issue-detail-layout">
                        ...
                        <div class="issue-col">
                            ...
                            <div id="top-supporters-widget" class="top-supporters-widget" style="display:none;">
                                <h4 class="top-supporters-title">Bill Supporters</h4>
